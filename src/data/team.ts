...
export const team: TeamMember[] = [
  {
    ...
    bio: "Former VP of Engineering at a Fortune 500 tech firm, Arjun spent 12 years building and scaling distributed engineering teams across three continents before founding Pacific Ocean Tech in 2015. He saw first-hand how the traditional outsourcing model failed both clients and engineers, and built POT around the principle that dedicated, embedded teams outperform project-based contractors every time. Under his leadership, POT has grown from a five-person remote agency to a trusted talent partner serving 200+ companies worldwide.",
